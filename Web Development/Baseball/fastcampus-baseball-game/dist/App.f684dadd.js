...
},{"./v1":"node_modules/uuid/v1.js","./v4":"node_modules/uuid/v4.js"}],"src/GameResult.js":[function(require,module,exports) {
"use strict";
...
var Baseball = /*#__PURE__*/function () {
  // #gameStore;
  function Baseball(digit, id, problem, history) {
    ...
    this.history = (history || []).map(function (v) {
      return {
        guess: v.guess,
        result: new _GameResult.default(v.result.digit, v.result.strike, v.result.ball)
      };
    });
  }
  ...
  _createClass(Baseball, [{
    ...
    value: function makeProblem() {
      ...
      for (var i = 0; i < this.digit; i++) {
        var max = 9 - i,
            index = (0, _utils.getRandomInt)(0, max);
    ...
    value: function getResult(guess) {
      ...
      var result = new _GameResult.default(this.digit, strike, ball);
      this.history.push({
        guess: guess,
        result: result
      });
...
},{"./utils":"src/utils.js","uuid":"node_modules/uuid/index.js","./GameResult":"src/GameResult.js"}],"src/GuessInputControl.js":[function(require,module,exports) {
"use strict";
...
var GuessInputControl = /*#__PURE__*/function () {
  function GuessInputControl(containerSelector) {
    ...
    this.inputE1.addEventListener('keydown', function (e) {
      if (e.keyCode === 13) {
...
},{}],"src/GameStore.js":[function(require,module,exports) {
"use strict";
...
var GameStore = /*#__PURE__*/function () {
  ...
  _createClass(GameStore, [{
    ...
    value: function getGames() {
      var data = localStorage.getItem(GameStore.KEY);
      return JSON.parse(data);
    }
  }, {
    key: "loadGame",
    value: function loadGame(gameID) {
      var found = this.getGames()[gameID];
      ...
      if (found) {
        ...
        return new _Baseball.default(digit, id, problem, history);
      } else {
        throw new Error("\uAC8C\uC784\uC744 \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4. gameID = ".concat(gameID));
      }
    }
  }, {
    key: "save",
    value: function save(game) {
      ...
      _classPrivateMethodGet(this, _setItem, _setItem2).call(this);
    }
  }, {
    key: "delete",
    value: function _delete(gameID) {
...
var _setItem2 = function _setItem2() {
  var jsonData = JSON.stringify(this.games);
  localStorage.setItem(GameStore.KEY, jsonData);
};
},{"./Baseball":"src/Baseball.js"}],"src/App.js":[function(require,module,exports) {
"use strict";
...
var _GameStore = _interopRequireDefault(require("./GameStore"));
...
var App = /*#__PURE__*/function () {
  function App() {
    ...
    var gameID = queryParam.get('id');
    this.resultContainerE1 = document.querySelector('.result-container');
    this.gameStore = new _GameStore.default();
  ...
  _createClass(App, [{
    ...
    value: function createNewGame() {
      return new _Baseball.default(this.digit);
    }
  }, {
    key: "saveGame",
    value: function saveGame() {
      this.gameStore.save(this.baseball);
      location.assign("game.html?id=".concat(this.baseball.id));
    }
  }, {
    key: "renderHistory",
    value: function renderHistory() {
      ...
      var resultsHtml = this.baseball.history.map(function (_ref) {
        var guess = _ref.guess,
            result = _ref.result;
        return _this.createResultEl(guess, result.toString());
    ...
    key: "createResultE1",
    value: function createResultE1(guess, result) {
...
new App();
},{"./Baseball":"src/Baseball.js","./GuessInputControl":"src/GuessInputControl.js","./GameStore":"src/GameStore.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
